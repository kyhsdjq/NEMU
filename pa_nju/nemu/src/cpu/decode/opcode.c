...
#define make_classic_6(name) \
    concat(name, _r2rm_b), concat(name, _r2rm_v) \
    , concat(name, _rm2r_b), concat(name, _rm2r_v) \
    , concat(name, _i2a_b), concat(name, _i2a_v)

instr_func opcode_entry[256] = {
    /* 0x00 - 0x03*/ make_classic_6(add),
    /* 0x04 - 0x07*/ inv, inv,
    /* 0x08 - 0x0b*/ make_classic_6(or),
    /* 0x0c - 0x0f*/ inv, opcode_2_byte,
    /* 0x10 - 0x13*/ make_classic_6(adc),
    /* 0x14 - 0x17*/ inv, inv,
    /* 0x18 - 0x1b*/ make_classic_6(sbb),
    /* 0x1c - 0x1f*/ inv, inv,
    /* 0x20 - 0x23*/ make_classic_6(and),
    /* 0x24 - 0x27*/ inv, inv,
    /* 0x28 - 0x2b*/ make_classic_6(sub),
    /* 0x2c - 0x2f*/ inv, inv,
    /* 0x30 - 0x33*/ make_classic_6(xor),
    /* 0x34 - 0x37*/ inv, inv,
    /* 0x38 - 0x3b*/ make_classic_6(cmp),
    /* 0x3c - 0x3f*/ inv, inv,
    ...
    /* 0x8c - 0x8f*/ inv, lea_rm2r_v, mov_rm2sr_v, inv,
    ...
    /* 0xc0 - 0xc3*/ group_2_b, group_2_v, near_ret_i_w, near_ret,
    /* 0xc4 - 0xc7*/ inv, inv, mov_i2rm_b, mov_i2rm_v,
    /* 0xc8 - 0xcb*/ inv, leave, inv, inv,
    /* 0xcc - 0xcf*/ inv, int_i_b, inv, iret,
    ...
    /* 0xe8 - 0xeb*/ call_i_v, jmp_near, jmp_lng_ptr, jmp_b,
    /* 0xec - 0xef*/ in_b, in_l, out_b, out_l,
...
instr_func opcode_2_byte_entry[256] = {
    ...
    /* 0x20 - 0x23*/ mov_cr2rm_l, inv, mov_rm2cr_l, inv,
