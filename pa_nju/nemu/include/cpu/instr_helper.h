...
#define make_instr_func_all(name) \
    ...
    make_instr_func(concat(name, _i2r_b));  \
    make_instr_func(concat(name, _i2r_v));  \
    make_instr_func(concat(name, _i2a_b));  \
    make_instr_func(concat(name, _i2a_v));  \
    make_instr_func(concat(name, _o2a_b));  \
    make_instr_func(concat(name, _o2a_v));  \
    make_instr_func(concat(name, _a2o_b));  \
    make_instr_func(concat(name, _a2o_v));

#define make_instr_impl_2op_all(name) \
    ...
    make_instr_impl_2op(name, i, r, b)  \
    make_instr_impl_2op(name, i, r, v)  \
    make_instr_impl_2op(name, i, a, b)  \
    make_instr_impl_2op(name, i, a, v)  \
    make_instr_impl_2op(name, a, o, b)  \
    make_instr_impl_2op(name, a, o, v)  \
    make_instr_impl_2op(name, o, a, b)  \
    make_instr_impl_2op(name, o, a, v)
...
#define condition_g \
	!(cpu.eflags.ZF || (cpu.eflags.SF && !cpu.eflags.OF) || (!cpu.eflags.SF && cpu.eflags.OF))

#define condition_ge \
	!((cpu.eflags.SF && !cpu.eflags.OF) || (!cpu.eflags.SF && cpu.eflags.OF))
